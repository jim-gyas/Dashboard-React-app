...
const ThemeSettings = () => {
  ...
  return (
    ...
    right-0'>
      <div className='float-right h-screen dark:text-gray-200 bg-white dark:[#488451]
      w-400'>
        <div className="flex justify-between items-center
        p-4 ml-4">
          <p className="font-semibold text-xl"> Settings</p>
          <button type="button"
          onClick={()=>setThemeSettings(false)} style={{color:'rgb(153,171,180)'
            ,borderRadius: '50%'
            ...
            {themeColors.map((item,index)=>(
              ...
              position="TopCenter">
                ...
                cursor-pointer flex gap-5  items-center'>
                   <button type='button' className='h-10 w-10
