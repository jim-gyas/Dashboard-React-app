  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        rounded-xl w-full lg:w-60 p-8 pt-9 m-3 bg-hero
       ...
       (
        ...
        backgroundColor: item.iconBg}} className='text-2xl opacity-90 rounded-full p-4 hover:drop-shadow-xl'>{item.icon}</button>
             ...
             <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                 ...
                 rounded-full bg-green-400 ml-3 text-xs'>23%</span>
                </p>
              ...
              <div className='mt-5'>
                ...
                height="80px" width="250px" data={SparklineAreaData}
                color={currentColor}/>
              </div>
              <div className="mt-10">
                <Button  
